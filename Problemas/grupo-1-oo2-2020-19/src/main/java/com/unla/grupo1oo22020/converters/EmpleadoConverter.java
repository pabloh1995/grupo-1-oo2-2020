...
public class EmpleadoConverter {
	...
	public EmpleadoModel entityToModel(Empleado empleado) {
		return new EmpleadoModel(empleado.getIdPersona(), empleado.getDni(), empleado.getApellido(),
				empleado.getNombre(), empleado.getFechaNacimiento(), empleado.getSueldoBasico(), empleado.getComision(),
				empleado.getHorarioTrabajoE(), empleado.getHorarioTrabajoS(), empleado.isGerente(),
				localConverter.entityToModel(empleado.getLocal()));
	}
