...
public class PedidoConverter {
	...
	public Pedido modelToEntity(PedidoModel pedidoModel) {
		return new Pedido(pedidoModel.getIdPedido(), pedidoModel.getFechaPedido(),
				...
				localConverter.modelToEntity(pedidoModel.getLocal()), empleadoConverter.modelToEntity(pedidoModel.getEmpleado()),
				clienteConverter.modelToEntity(pedidoModel.getCliente()),pedidoModel.getPrecioTotal(), pedidoModel.isResuelto());
	}
