...
public class ClienteConverter {
	...
	public Cliente modelToEntity(ClienteModel clienteModel) {
		return new Cliente(clienteModel.getIdPersona(), clienteModel.getDni(), clienteModel.getApellido(),
				clienteModel.getNombre(), clienteModel.getFechaNacimiento(), clienteModel.getEmail());
	}
