...
public class VentaController {
	...
	public ModelAndView reporteventasresultado(@ModelAttribute("local") LocalModel local,@RequestParam("desde") @DateTimeFormat(pattern = "yy-MM-dd") Date desde,@RequestParam("hasta") @DateTimeFormat(pattern = "yy-MM-dd") Date hasta) {
