...
public class PedidoController {
	...
	public RedirectView generarVenta(@PathVariable("idPedido") long idPedido) {
		...
		//ventaService.insert(ventaModel); QUIZA NO VA
		//pedidoService.remove(idPedido); CORREGIR ESTO
		
		//lo elimino de pedidos
    ...
    private void guardarPedido(ArrayList<Pedido> pedidos, HttpServletRequest request) {
        request.getSession().setAttribute("pedido", pedidos);
    }*/
