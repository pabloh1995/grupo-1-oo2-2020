...
public class SolicitudStockService implements ISolicitudStockService{
	...
	public void setAttributes(SolicitudStockModel solicitudStockModel) {
		solicitudStockModel.setLocal(localService.findByIdLocal(empleadoService.findByIdPersona(pedidoService.getEmpleado().getIdPersona()).getLocal().getIdLocal()));
		solicitudStockModel.setProducto(productoService.findByIdProducto(pedidoService.getProducto().getIdProducto()));
		solicitudStockModel.setCantidad(pedidoService.getCantidad());
		solicitudStockModel.setEmpleado(empleadoService.findByIdPersona(pedidoService.getEmpleado().getIdPersona()));
